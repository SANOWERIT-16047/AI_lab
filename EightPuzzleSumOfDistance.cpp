 ...
 *Compare those generated state with goal stata for sum of distances out of place
 */
...
int main ()
{
    ...
    std::cout << "Sum of distances out of place for state1: "
              << findTileOutOfPlace (state1, goalState) + 1 << "\n";
    std::cout << "Sum of distances out of place for state2: "
              << findTileOutOfPlace (state2, goalState) + 1 << "\n";
    std::cout << "Sum of distances out of place for state3: "
              << findTileOutOfPlace (state3, goalState) + 1 << "\n";
    return EXIT_SUCCESS;
}